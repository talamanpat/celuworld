...
<html lang="es">
    <head>
        ...
        <title><?php echo $title_for_layout; ?>. Especificaciones, reviews, videos, análisis y más!</title> 
        <?php
            ...
            <div id="contenido">
                ...
                <div id="contenidoColDer">  
                    <aside>
                        ...
                        <div class="sideElement" >
                            <a href="http://movil.talaman.cl" target="_blank"><img src="http://info.talaman.cl/img/qrcode.jpg" alt="talaman versión móvil" width="160"/></a>
                        </div>
