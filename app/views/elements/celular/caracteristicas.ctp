...
//            e($utilidad->rowBoolMandatory($celular['Especificacion']['modem_wifi'], "Modem wifi", "No"));
           // e($utilidad->rowBool($celular['Especificacion']['modem_wifi'], "Modem wifi"));
...
//            e($utilidad->rowTxt($celular['Especificacion']['sd_default'], "Default"));
            e($utilidad->rowTxtMandatory($celular['Especificacion']['sd_max'], "Expandible"));
            e($utilidad->rowTxtMandatory($celular['Especificacion']['camara'] . " MPX", "Cámara"));
            e($utilidad->rowBoolMandatory($celular['Especificacion']['flash'], "Flash", "No"));
            e($utilidad->rowBoolMandatory($celular['Especificacion']['video_llamada'], "Cámara frontal", "No"));
