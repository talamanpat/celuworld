<h2 id="titulo-descripcion" class="subTitulo">Descripción, Análisis y Características</h2>
...
<!--                        <td><h3> <?php e($utilidad->booleanosSN($celular['Celular']['vigente'])); ?></h3></td>-->
                        <td><h3> <?php e($gamas[$celular['Especificacion']['gama_id']]); ?></h3></td>
                    </tr>
                </table>
                <div id="descSocial">
    ...
    <div class="ColDerDesc">
        <article>
            <div class="DatosDesDer">
                <p><?php
                                e($text->truncate(strip_tags($celular['Especificacion']['analisis']), 550, array(
                                            'ending' => '... ' 
//                                            $this->Html->link(
//                                                    "ver el análisis", "#analisisLB", array(
//                                                'title' => "Análisis del " . $celular['Marca']['marca'] . " " . $celular['Celular']['modelo'],
//                                                'class' => 'popupLB'
//                                                        
//                                                    )
//                                            ),
                                ...
                                e('</p><p id="analisisP">' .$this->Html->link(
                                                    "Expandir/Contraer análisis", "#analisisLB", array(
                                                'title' => "Análisis del " . $celular['Marca']['marca'] . " " . $celular['Celular']['modelo'],
                                                'class' => 'analisisBoton'                                                        
                                                    )
                                            ).'</p>');
...
<div id="analisis" class="bloque">
    <h2>Análisis</h2>
        <?php e($celular['Especificacion']['analisis']); 
        e($this->Html->link(
                                                    "Expandir/Contraer análisis", "#titulo-descripcion", array(
                                                'title' => "Análisis del " . $celular['Marca']['marca'] . " " . $celular['Celular']['modelo'],
                                                'class' => 'analisisBoton','style'=>'float:right'                                                        
                                                    )
                                            ));?>
</div>