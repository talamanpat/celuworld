...
<article>
    <div class="bloque" id="noticias">
        <h2 class="verde">
            <?php e($this->Html->link($noticia['Noticia']['titulo'], array('action' => 'ver', $noticia['Noticia']['id_noticia']), array('escape' => false))); ?></h2>
            <?php
        ...
        <div id="seguirComen">
            <?php
            e($this->Html->link(__('Seguir leyendo ' . $noticia['Noticia']['titulo'], true), array('action' => 'ver', $noticia['Noticia']['id_noticia']), array('class' => 'underline')
                    )
            );
            ?>
